<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.Master" CodeBehind="UPDATE.aspx.cs" Inherits="StudentRegisition.UPDATE" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <center>
        <h1 class="text-align:center">Edit Form</h1>
    </center>
    <div class="container">
        <div class="row">
...
<%--        <div class="row">
            ...
            <div class="form-group">
                <div class="col-md-4">
                    ...
                    <asp:TextBox ID="txtPassord" runat="server" CssClass="form-control" Width="300">
                    </asp:TextBox>
                </div>
            </div>
            <div class="form-group">
  ...
  <asp:Button ID="txtupdate" runat="server" Text="UPDATE" CssClass="btn btn-success" class="form-control" Width="100" OnClick="txtupdate_Click"  />
